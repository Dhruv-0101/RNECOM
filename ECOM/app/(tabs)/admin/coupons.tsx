...
export default function AdminCoupons() {
  ...
  const [modalType, setModalType] = useState<"addCoupon" | "editCoupon" | null>(
    null,
  );
            ...
            <ScrollView contentContainerStyle={styles.modalScroll}>
              <View>
                ...
                <Input
                  ...
                  onChangeText={(val) =>
                    setCouponForm((p) => ({ ...p, discount: val }))
                  }
                />
                <Input
                  ...
                  onChangeText={(val) =>
                    setCouponForm((p) => ({ ...p, startDate: val }))
                  }
                />
                <Input
